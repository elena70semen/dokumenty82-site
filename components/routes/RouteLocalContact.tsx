                ...
                <div className="grid gap-4">
                  ...
                  <div className="grid grid-cols-[48px_1fr] gap-4 rounded-[8px] border border-[var(--line)] bg-[var(--surface-raised)] p-4">
                    ...
                    <div>
                      ...
                      <a
                        href={site.phoneHref}
                        className="mt-2 inline-flex min-h-10 items-center rounded-[8px] text-lg font-black text-[color:var(--text-primary)] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-[var(--focus-on-light)]"
