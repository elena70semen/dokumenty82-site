      ...
      <div className="container-premium grid gap-9 lg:grid-cols-[1.1fr_0.88fr_1.02fr]">
        ...
        <div className="text-sm leading-7 text-[color:var(--text-inverse-muted)]">
          ...
          <div className="mt-4 flex flex-wrap gap-2">
            <a href={homeFooter.phoneHref} className="rounded-[8px] bg-[var(--lime-signal)] px-4 py-2 text-sm font-black text-[color:var(--lime-text)]">
              Позвонить
            </a>
            <Link href="/kontakty/" className="rounded-[8px] border border-[var(--border-dark-soft)] px-4 py-2 text-sm font-black text-[color:var(--text-inverse)]">
              Построить маршрут
            </Link>
          </div>
        </div>
