...
export const routePageData: Record<(typeof routePageSlugs)[number], RoutePageConfig> = {
  "razbor-situacii": {
    ...
    documents: {
      ...
      items: [
        ...
        { title: "Документы на руках", copy: "Перечень документов без публичной загрузки файлов.", icon: "folder", badgeKind: "office" }
      ]
    },
    related: [
      {
  ...
  kontakty: {
    ...
    hero: {
      ...
      title: "Контакты и передача документов",
      text: "Позвоните, постройте маршрут в офис или согласуйте безопасный способ показать документы. На странице указаны только проверенные контакты.",
      icon: "location",
      badgeKind: "office",
    ...
    situation: {
      ...
      title: "Контакты помогают выбрать звонок, визит или показ документов",
      ...
      items: [
        {
          ...
          copy: "Используйте номер, указанный на сайте, без обещаний доступности по времени.",
          icon: "phone",
          badgeKind: "contact"
        },
        {
    ...
    scope: {
      eyebrow: "Проверенные контакты",
      title: "На странице только проверенные данные и безопасные действия",
      text: "Публикуем телефон, адрес и понятный ориентир. Остальные детали лучше уточнить лично, чтобы не вводить в заблуждение.",
      includedTitle: "Что есть на странице",
      included: [site.name, site.category, site.phone, site.address, site.landmark],
      boundaryTitle: "Что уточняем отдельно",
      boundaries: [
    ...
    documents: {
      id: "show-documents",
      eyebrow: "Безопасный показ документов",
    ...
    localContact: {
      ...
      text: "Используем только проверенный адрес и телефон. Остальные детали лучше уточнить лично.",
      actions: [
        { label: "Позвонить", href: site.phoneHref, kind: "phone" },
    ...
    safetyNote: "Контактная страница использует только проверенные данные: телефон, адрес и локальный ориентир."
  },
  otchetnost: {
    slug: "otchetnost",
    href: "/otchetnost/",
    ...
    metadataDescription:
      "Раздел по отчётности для бизнеса: УСН, нулевая отчётность, восстановление данных и ответ на требование ИФНС.",
    hero: {
    ...
    situation: {
      ...
      text: "Раздел помогает понять, какая тема ближе к вашему вопросу и куда перейти дальше.",
      items: [
        {
  ...
  "bank-i-115-fz": {
    ...
    situation: {
      ...
      text: "Один запрос и широкий вопрос по 115-ФЗ требуют разных действий. Раздел помогает не смешивать эти ситуации.",
      items: [
        {
