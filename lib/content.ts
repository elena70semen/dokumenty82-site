...
const reportingCheck = [
  "форму бизнеса, режим и период",
  "были ли операции, деятельность или пробелы в данных",
  "какие документы уже есть и где не хватает вводных",
  "не ведёт ли вопрос к требованию ИФНС, восстановлению или сопровождению"
];
const reportingInputs = [
  "данные по периоду и режиму",
  "письма или требования, если они есть",
  "текущий комплект отчётных и учетных материалов",
  "перечень пробелов без публичной загрузки файлов"
];
const reportingStart = [
  "фиксируем ООО или ИП, режим и период",
  "отделяем хаб от точной страницы",
  "проверяем, есть ли нулевой, декларационный или восстановительный случай",
  "выбираем безопасный документальный маршрут"
];
const reportingBoundaries = [
  "готовый вывод без исходных данных",
  "автоматическую отправку через публичную страницу",
  "решение внешней стороны",
  "точный объём до проверки комплекта"
];

const bankCheck = [
  "текст запроса или вопрос банка",
  "операцию, контрагента и период вопроса",
  "какие подтверждающие материалы относятся к пунктам банка",
  "границы ответа и пакета документов по 115-ФЗ"
];
const bankInputs = [
  "формулировку банка",
  "договоры, акты или платежные материалы как категории",
  "краткое описание деловой ситуации",
  "что уже готовилось по этой операции или контрагенту"
];
const bankStart = [
  "смотрим формулировку",
  "определяем объем вопроса",
  "отделяем один ответ от широкого пакета",
  "собираем безопасный перечень материалов"
];
const bankBoundaries = [
  "решение банка",
  "универсальный пакет без запроса",
  "передачу чувствительных материалов через публичную страницу",
  "обещание разблокировки или принятия пояснений"
];

const addressCheck = [
  "текущие сведения компании",
  "источник адресного вопроса",
  "связан ли вопрос с регистрацией, сменой адреса или недостоверностью",
  "какие подтверждающие материалы уже есть"
];
const addressInputs = [
  "выписку или уведомление, если оно есть",
  "документы по адресу",
  "описание планируемого изменения",
  "связанные сведения ООО без неподтвержденных офисных деталей"
];
const addressStart = [
  "отделяем адрес от других изменений",
  "проверяем исходный комплект",
  "выбираем между адресом, недостоверностью, сменой адреса и директором",
  "фиксируем следующий документальный маршрут"
];
const addressBoundaries = [
  "решение регистрирующей стороны",
  "снятие отметки без проверки основания",
  "использование неподтвержденных данных",
  "обещание, что адрес или изменение будут приняты"
];

const registrationCheck = [
  "форму будущего или текущего бизнеса",
  "участников задачи и исходные сведения",
  "адресный и режимный вопрос как отдельные вводные",
  "какой комплект нужен для следующего шага"
];
const registrationInputs = [
  "краткое описание задачи",
  "сведения, которые уже подготовлены",
  "документы компании, если бизнес уже действует",
  "адресный или налоговый вопрос, если он влияет на маршрут"
];
const registrationStart = [
  "уточняем жизненный цикл задачи",
  "отделяем регистрацию от изменений и ликвидации",
  "проверяем, не нужен ли адресный или налоговый маршрут",
  "собираем стартовый комплект"
];
const registrationBoundaries = [
  "решение внешней стороны",
  "финальный маршрут без исходных данных",
  "выводы вместо разбора",
  "обещание результата регистрации до проверки вводных"
];

const taxCheck = [
  "текущий режим и исходные данные",
  "применимость выбранного маршрута",
  "связь с отчетностью, УСН, АУСН или НДС",
  "какой вопрос является диагностикой, а какой подготовкой документов"
];
const taxInputs = [
  "данные бизнеса",
  "режим и период, если известны",
  "вопрос, который нужно проверить",
  "связанные отчётные материалы как категории"
];
const taxStart = [
  "собираем вводные",
  "отделяем переход от диагностики",
  "проверяем связь с отчетностью",
  "фиксируем безопасный следующий шаг"
];
const taxBoundaries = [
  "налоговый вывод без вводных",
  "расчет вместо разбора документов",
  "решение внешней стороны",
  "универсальный вывод без проверки вводных"
];

const hrCheck = [
  "кадровое событие или регулярную задачу",
  "какие документы сотрудников уже есть",
  "какие данные нельзя передавать публично",
  "нужен ли разовый маршрут или сопровождение"
];
const hrInputs = [
  "описание кадрового события",
  "перечень имеющихся документов",
  "данные без публичной загрузки",
  "сигнал, вопрос разовый или повторяющийся"
];
const hrStart = [
  "сначала согласуем способ показа материалов",
  "отделяем срочный вопрос от сопровождения",
  "фиксируем безопасные вводные без персональных данных",
  "готовим документальный маршрут"
];
const hrBoundaries = [
  "кадровое решение без вводных",
  "публичную передачу персональных данных",
  "регулярный формат без согласования объема",
  "обещание точной даты оформления"
];
...
const routeHardeningBySlug: Record<string, Partial<RoutePage>> = {
  "srochnye-voprosy": {
    ...
    relatedHrefs: ["/otvet-na-trebovanie-ifns/", "/otchetnost/", "/bank-i-115-fz/", "/razbor-situacii/"],
  ...
  otchetnost: {
    ...
    metadataDescription:
      "Хаб отчетности помогает выбрать точную страницу: УСН, нулевая отчетность, электронный маршрут, восстановление учета или ответ ИФНС.",
  ...
  "nalogi-i-rezhimy": {
    ...
    indexing: "index",
    includeInSitemap: true,
    relatedHrefs: ["/perehod-na-ausn/", "/ausn-krym/", "/raschet-nalogovoy-nagruzki/", "/nds-pri-usn-2026/", "/otchetnost/"],
    pageBlockModel: hubPageBlockModel,
  ...
  "bank-i-115-fz": {
    ...
    indexing: "index",
    includeInSitemap: true,
    relatedHrefs: ["/otvet-na-zapros-banka/", "/dokumenty-dlya-banka-115-fz/", "/srochnye-voprosy/", "/vosstanovlenie-buhucheta/"],
    pageBlockModel: hubPageBlockModel,
  ...
  "registraciya-i-likvidaciya": {
    ...
    indexing: "index",
    includeInSitemap: true,
    relatedHrefs: ["/registraciya-ooo/", "/registraciya-ip/", "/likvidaciya-ooo/", "/adres-egryul-direktor/", "/nalogi-i-rezhimy/"],
    pageBlockModel: hubPageBlockModel,
  ...
  "otvet-na-trebovanie-ifns": {
    ...
    indexing: "index",
    includeInSitemap: true,
    relatedHrefs: ["/srochnye-voprosy/", "/otchetnost/", "/deklaraciya-usn/", "/vosstanovlenie-buhucheta/"],
  ...
  "nulevaya-otchetnost-ooo": {
    ...
    whatWeCheck: ["статус деятельности ООО по периоду", "наличие операций и исходных документов", "связь с декларацией УСН или восстановлением", "какие материалы относятся именно к ООО"],
    documentsOrData: ["данные ООО по периоду", "сведения о деятельности или её отсутствии", "текущий комплект отчётных материалов", "письма или требования, если они есть"],
    howWorkStarts: ["фиксируем период и форму ООО", "отделяем нулевой маршрут от декларации и восстановления", "собираем безопасный перечень вводных", "выбираем точную отчётную страницу"],
    notPromised: reportingBoundaries,
    schemaBoundary: serviceSchemaBoundary,
  ...
  "nulevaya-otchetnost-ip": {
    ...
    whatWeCheck: ["режим ИП и период вопроса", "была ли деятельность или операции", "связь с декларацией УСН или сопровождением ИП", "какие материалы относятся именно к ИП"],
    documentsOrData: ["данные ИП по периоду", "режим, если он известен", "сведения о деятельности или её отсутствии", "письма или требования, если они есть"],
    howWorkStarts: ["фиксируем режим и период ИП", "отделяем нулевой маршрут от декларации", "проверяем, не нужен ли маршрут сопровождения", "собираем безопасный перечень вводных"],
    notPromised: reportingBoundaries,
    schemaBoundary: serviceSchemaBoundary,
    holdRisks: ["tax_conclusion", "activity_status", "source_gap"],
  ...
  "vosstanovlenie-buhucheta": {
    ...
    indexing: "index",
    includeInSitemap: true,
    relatedHrefs: ["/otchetnost/", "/deklaraciya-usn/", "/buhgalterskoe-soprovozhdenie-ooo/", "/buhgalterskoe-soprovozhdenie-ip/", "/soprovozhdenie/"],
    pageBlockModel: standardMoneyPageBlockModel,
  ...
  "otchetnost-elektronno": {
    relatedHrefs: ["/otchetnost/", "/deklaraciya-usn/", "/nulevaya-otchetnost-ooo/", "/nulevaya-otchetnost-ip/"],
  ...
  "yuridicheskiy-adres-simferopol": {
    ...
    indexing: "index",
    includeInSitemap: true,
    relatedHrefs: ["/adres-egryul-direktor/", "/nedostovernost-yuridicheskogo-adresa/", "/smena-yuridicheskogo-adresa-ooo/", "/registraciya-ooo/"],
    pageBlockModel: standardMoneyPageBlockModel,
  ...
  "registraciya-ooo": {
    ...
    indexing: "index",
    includeInSitemap: true,
    relatedHrefs: ["/registraciya-i-likvidaciya/", "/registraciya-ip/", "/yuridicheskiy-adres-simferopol/", "/nalogi-i-rezhimy/"],
    pageBlockModel: standardMoneyPageBlockModel,
  ...
  "registraciya-ip": {
    ...
    indexing: "index",
    includeInSitemap: true,
    relatedHrefs: ["/registraciya-i-likvidaciya/", "/registraciya-ooo/", "/nalogi-i-rezhimy/", "/buhgalterskoe-soprovozhdenie-ip/"],
    pageBlockModel: standardMoneyPageBlockModel,
  ...
  "likvidaciya-ooo": {
    ...
    indexing: "index",
    includeInSitemap: true,
    relatedHrefs: ["/registraciya-i-likvidaciya/", "/registraciya-ooo/", "/soprovozhdenie/", "/adres-egryul-direktor/"],
    pageBlockModel: standardMoneyPageBlockModel,
  ...
  "perehod-na-ausn": {
    relatedHrefs: ["/nalogi-i-rezhimy/", "/ausn-krym/", "/raschet-nalogovoy-nagruzki/", "/nds-pri-usn-2026/", "/deklaraciya-usn/"],
    whatWeCheck: taxCheck,
    documentsOrData: taxInputs,
    howWorkStarts: taxStart,
    notPromised: taxBoundaries
  ...
  "srochnoe-oformlenie-sotrudnikov": {
    relatedHrefs: ["/kadry/", "/kadrovoe-soprovozhdenie/", "/kontakty/"],
    whatWeCheck: hrCheck,
    documentsOrData: hrInputs,
    howWorkStarts: hrStart,
    notPromised: hrBoundaries
  ...
  "kadrovoe-soprovozhdenie": {
    relatedHrefs: ["/kadry/", "/srochnoe-oformlenie-sotrudnikov/", "/soprovozhdenie/", "/razbor-situacii/"],
    whatWeCheck: hrCheck,
    documentsOrData: hrInputs,
    howWorkStarts: hrStart,
    notPromised: hrBoundaries
  ...
  "buhgalterskoe-soprovozhdenie-ooo": {
    relatedHrefs: ["/soprovozhdenie/", "/buhgalterskoe-soprovozhdenie-ip/", "/deklaraciya-usn/", "/vosstanovlenie-buhucheta/"],
  ...
  "buhgalterskoe-soprovozhdenie-ip": {
    relatedHrefs: ["/soprovozhdenie/", "/buhgalterskoe-soprovozhdenie-ooo/", "/deklaraciya-usn/", "/nulevaya-otchetnost-ip/"],
...
export const hubs: RoutePage[] = [
  {
    ...
    longText: [
      ...
      "Принесите то, что уже есть: письма, требования, выписки, договоры, черновики и переписку. После разбора станет понятнее, это ИФНС, банк, отчётность, адрес, кадры или общий маршрут.",
      "Срочность здесь не превращается в обещание срока. Сначала смотрим источник вопроса и выбираем точную страницу, чтобы не смешать соседние интенты."
    ],
    pageType: "hub"
  },
  {
    ...
    longText: [
      ...
      "Если документы неполные или периоды расходятся, маршрут может вести не в декларацию, а в восстановление учёта или первичный разбор."
    ],
    pageType: "hub"
  },
  {
  ...
  },
  {
    ...
    longText: [
      ...
      "Если банковский вопрос упирается в первичку, договоры или учётные пробелы, рядом есть маршрут восстановления бухучёта."
    ],
    pageType: "hub"
  },
  {
...
export const services: RoutePage[] = [
  {
    ...
    longText: [
      ...
      "Срок и формат ответа смотрим по самому требованию и исходным документам, а не обещаем заранее на странице."
    ],
  ...
  },
  {
    ...
    longText: [
      ...
      "Страница подходит, когда проблема не в одном отчёте, а в неполных регистрах, первичке, периодах или связке с письмами ИФНС и банка."
    ],
    parentHref: "/otchetnost/",
    pageType: "money"
  },
  {
    ...
    longText: [
      ...
      "Если вопрос не в электронном канале, а в составе отчёта, периоде или пробелах, маршрут ведёт обратно в отчётный хаб."
    ],
    parentHref: "/otchetnost/",
  ...
  },
  {
    ...
    longText: [
      ...
      "Не обещаем выгоду или применимость заранее: рядом есть диагностика АУСН в Крыму, налоговая нагрузка и связка с отчётностью."
    ],
  ...
  },
  {
    ...
    longText: [
      ...
      "Пакет может опираться на договоры, акты, платежи и деловую цель как категории, но решение банка остаётся вне обещаний страницы."
    ],
    parentHref: "/bank-i-115-fz/",
    pageType: "money"
  },
  {
    ...
    longText: [
      ...
      "Локальный контекст Симферополя помогает с маршрутом, но не заменяет проверку документов и не обещает результат регистрации."
    ],
  ...
  },
  {
    ...
    longText: [
      ...
      "Если источник проблемы - отметка или риск по адресу, сначала лучше открыть маршрут недостоверности, а не смешивать его со сменой."
    ],
    parentHref: "/adres-egryul-direktor/",
    pageType: "money"
  },
  ...
  },
  {
    ...
    longText: [
      ...
      "Связанные адресные или регистрационные вопросы выносим в соседние маршруты, чтобы одна страница не захватывала весь ЕГРЮЛ-интент."
    ],
    parentHref: "/adres-egryul-direktor/",
    pageType: "money"
  },
  {
    ...
    longText: [
      ...
      "Эта страница про разовое кадровое событие. Если задачи повторяются, лучше перейти на кадровое сопровождение."
    ],
    parentHref: "/kadry/",
    primaryCtaLabel: cta.docs,
    primaryCtaHref: "/razbor-situacii/",
  ...
  },
  {
    ...
    longText: [
      ...
      "Если вопрос связан только с выходом конкретного сотрудника, маршрут возвращает на срочное оформление сотрудников."
    ],
    parentHref: "/kadry/",
    primaryCtaLabel: cta.primary,
    primaryCtaHref: "/razbor-situacii/",
  ...
  },
  {
    ...
    longText: [
      ...
      "Страница не обещает результат регистрации: она помогает собрать стартовые сведения и не смешать ООО с ИП или изменениями действующей компании."
    ],
  ...
  },
  {
    ...
    longText: [
      ...
      "Если вопрос уже не про запуск, а про отчётность или сопровождение ИП, лучше перейти на соседнюю страницу."
    ],
    parentHref: "/registraciya-i-likvidaciya/",
    pageType: "money"
  },
  {
    ...
    longText: [
      ...
      "Не обещаем завершение процедуры заранее: состав следующего шага зависит от документов компании и текущего статуса."
    ],
    parentHref: "/registraciya-i-likvidaciya/",
    pageType: "money"
  },
  {
    ...
    longText: [
      ...
      "Регулярный формат обсуждается только после просмотра вводных: публичная страница не фиксирует объём или коммерческие условия регулярной работы."
    ],
  ...
  },
  {
    ...
    longText: [
      ...
      "Если вопрос ограничен одним периодом или нулевой отчётностью, страница ведёт на точный отчётный маршрут."
    ],
    parentHref: "/soprovozhdenie/",
    primaryCtaLabel: cta.primary,
    primaryCtaHref: "/razbor-situacii/",
...
export const diagnostics: RoutePage[] = [
  {
    ...
    longText: [
      ...
      "Крымский контекст отмечаем как часть маршрута, но применимость проверяется по вводным, а не по общей формулировке."
    ],
    parentHref: "/nalogi-i-rezhimy/",
    pageType: "diagnostic"
  },
  {
    ...
    longText: [
      ...
      "Страница не обещает экономию и не выводит итог публично: она помогает понять, какие данные нужны для проверки."
    ],
    parentHref: "/nalogi-i-rezhimy/",
    pageType: "diagnostic"
  },
  {
    ...
    longText: [
      ...
      "Если вопрос переходит в подготовку декларации или общий расчёт нагрузки, связанные маршруты помогают не смешивать интенты."
    ],
    parentHref: "/nalogi-i-rezhimy/",
    pageType: "diagnostic"
  }
