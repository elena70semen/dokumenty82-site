...
const groups = [
  ...
  },
  {
    ...
    items: [
      ["/buhgalterskie-uslugi/", "Бухгалтерские услуги в Симферополе", "Общий маршрут: сопровождение ИП и ООО, разовая отчётность, налоги, сотрудники и восстановление учёта."],
  ...
  },
  {
    ...
    items: [
      ...
      ["/registraciya-ip/", "Регистрация ИП в Симферополе", "ОКВЭД, налоговый режим, заявление Р21001 и маршрут подачи. Подготовка документов от 5 000 ₽."],
      ["/registraciya-ooo/", "Регистрация ООО в Симферополе", "Участники, директор, адрес, устав, ОКВЭД и заявление Р11001. Подготовка документов от 10 000 ₽."],
...
html = html.replace(/\/assets\/site\.css\?v=\d+/g, "/assets/site.css?v=202607221605");
