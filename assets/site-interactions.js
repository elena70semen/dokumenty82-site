(function () {
  ...
  function clearLegacyDocumentsHash() {
...
(function () {
  ...
  document.addEventListener("click", function (event) {
    ...
    const goal = normalizeGoal(target.getAttribute("data-event-name"));
    if (!goal) return;
    try { window.ym(COUNTER_ID, "reachGoal", goal); } catch (_) {}
  }, true);
})();
